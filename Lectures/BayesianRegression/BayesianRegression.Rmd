...
$$g(\boldsymbol{\beta},z_{i,t}) = \textrm{log}\big(z_{i,t-1}e^{\,\beta_{0,i}\,+\, \beta_{1}\textrm{wsic}_{i,t} \,+\, \beta_{2}\textrm{ssic}_{i,t} \,+\, \beta_{3}\textrm{krill}_{i,t}}\big)$$
...
$$\beta_{0,i}\sim\text{normal}(\mu_{\,\text{site}},\varsigma_{\,\text{site}})$$
